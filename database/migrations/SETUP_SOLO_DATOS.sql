-- =====================================================
-- SETUP SOLO DATOS - Vecino Activo
-- Sin policies, solo creación de datos de prueba
-- Tiempo estimado: 20 segundos
-- =====================================================

-- =====================================================
-- PASO 1: CREAR TABLA PHOTO_COMMENTS (si no existe)
-- =====================================================
...
-- Nota: Ignora errores si las tablas ya están en Realtime
...
-- 
-- NOTAS:
-- - Si ves errores sobre Realtime, es normal (tablas ya agregadas)
-- - Las policies de photo_comments deben configurarse manualmente
-- - Crear bucket "photos" en Storage si aún no existe
-- 
-- ¡Tu app tiene datos de prueba listos!
-- =====================================================
