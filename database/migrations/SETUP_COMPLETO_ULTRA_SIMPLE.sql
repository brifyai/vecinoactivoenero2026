-- =====================================================
-- SETUP COMPLETO ULTRA SIMPLE - Vecino Activo
-- Sin bloques DO $ para máxima compatibilidad
-- Tiempo estimado: 30 segundos
-- =====================================================

-- =====================================================
-- PASO 1: CREAR TABLA PHOTO_COMMENTS
-- =====================================================
...
-- Policies para photo_comments (se crean solo si no existen)
CREATE POLICY IF NOT EXISTS "Users can view photo comments"
ON photo_comments FOR SELECT
TO authenticated
USING (true);

CREATE POLICY IF NOT EXISTS "Users can create photo comments"
...
-- Nota: Si alguna tabla ya está en Realtime, se ignora el error
...
UPDATE posts p
SET likes = (SELECT COUNT(*) FROM post_reactions pr WHERE pr.post_id = p.id);
...
SELECT '' as separador, '' as detalle
UNION ALL
SELECT 'TABLAS CON REALTIME:' as separador, COUNT(*)::TEXT as detalle
...
-- =====================================================
-- 
-- IMPORTANTE: Crear bucket "photos"
