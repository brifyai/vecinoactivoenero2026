...
Plataforma completa para gestión de comunidades vecinales (Unidades Vecinales) con red social integrada, panel administrativo, sistema de tickets, campañas de comunicación y más. Construida con React, Redux Toolkit, Supabase (PostgreSQL) y Firebase para funcionalidades en tiempo real.
